                ...
                >
                    {
                        data.map(({ id, src }) => {
                            return (
                                <SwiperSlide key={id}>
                                    <div className="project-image bg-image" style={{ backgroundImage: `url(${src})` }}></div>
                                </SwiperSlide>
                            )
                        })
                    }
                    ...
                    <div className="row">
                        <div className="col-lg-6 bor-right py-lg-5">
                            <SectionTitle>
                                ...
                                <SectionTitle.Title>Successfully completed projects for our clients</SectionTitle.Title>
                                <SectionTitle.Description>We have facility to produce advance work various industrial <br /> applications based on specially developed technol-ogy.</SectionTitle.Description>
                            </SectionTitle>
                            ...
                            >
                                {
                                    data.map(({ id, src }) => {
                                        return (
                                            <SwiperSlide key={id}>
                                                <div className="image"><img src={src} alt='img' /></div>
                                            </SwiperSlide>
                                        )
                                    })
                                }
