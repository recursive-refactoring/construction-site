      ...
      <div className="container">
        <SectionTitle className={"text-center position-relative"}>
          {shop_single_title ? (
            ...
            <>
              <SectionTitle.Name>Why Choose Us</SectionTitle.Name>
              <SectionTitle.Title className={title_sytle}>
        ...
        >
          {productData.map(
            ({ discount_price, id, price, thumbnail, title }) => (
              <SwiperSlide key={id}>
                <ProductCard
                  id={id}
          ...
          <button className="arry-prev product-arry-prev">
            <i>
              <TfiAngleLeft />
            </i>
          </button>
          <button className="arry-next product-arry-next">
            <i>
              <TfiAngleRight />
            </i>
          </button>
